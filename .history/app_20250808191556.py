...
access_key = "db5966b017cae590a878335fb0e29128"
...
def landing_page():
    try:
        url = f"https://api.exchangerate.host/live?access_key=db5966b017cae590a878335fb0e29128&currencies=SGD"
        response = requests.get(url)
        data = response.json()
        rate = round(data['rates']['SGD'], 4)
