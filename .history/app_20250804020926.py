...
def fluctuation_data():
    ...
    # You must use your actual key from exchangerate.host
    access_key = "a0767682fe403d0dba5bc199800880b1"
    ...
    try:
        url = (
            ...
            f"access_key={access_key}&base={base}&symbols={symbols}"
